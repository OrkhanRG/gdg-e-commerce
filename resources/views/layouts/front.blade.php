                                            ...
                                            <div class="nav-brand-swiper swiper-container">
                                                <div class="swiper-wrapper">
                                                    <div class="swiper-slide">
                                                        <a href="">
                                                            <img src="{{ asset('assets/images/product2.webp') }}" class="img-fluid" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="swiper-slide">
                                                        <a href="">
                                                            <img src="{{ asset('assets/images/product3.jpeg') }}" class="img-fluid" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="swiper-slide">
                                                        <a href="">
                                                            <img src="{{ asset('assets/images/product4.jpeg') }}" class="img-fluid" alt="">
                                                        </a>
                                                    </div>
